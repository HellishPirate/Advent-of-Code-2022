...
draw_rock = sum(c1 == "A" & c2 == "Y")*3 + sum(c1 == "A" & c2 == "Y");
draw_paper = sum(c1 == "B" & c2 == "Y")*3 + sum(c1 == "B" & c2 == "Y")*2;
draw_scissors = sum(c1 == "C" & c2 == "Y")*3 + sum(c1 == "C" & c2 == "Y")*3;
draw_points = draw_rock + draw_paper + draw_scissors;

win_rock = sum(c1 == "C" & c2 == "Z")*6 + sum(c1 == "C" & c2 == "Z");
win_paper = sum(c1 == "A" & c2 == "Z")*6 + sum(c1 == "A" & c2 == "Z")*2;
...
lose_paper = sum(c1 == "C" & c2 == "X")*0 + sum(c1 == "C" & c2 == "X")*2;
lose_scissors = sum(c1 == "A" & c2 == "X")*0 + sum(c1 == "A" & c2 == "X")*3;
